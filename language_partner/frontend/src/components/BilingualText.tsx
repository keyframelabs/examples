...
const segmentClass = "bilingual-segment -mx-0.5 inline max-w-full appearance-none whitespace-normal break-words rounded-sm border-0 bg-transparent px-0.5 py-0 text-left text-inherit focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring";
            ...
            return (
              <span key={`${language}-${index}`}>
                ...
                <button
                  ...
                  onClick={() => onSelectionChange(pinned === index ? null : { ownerId, index })}
